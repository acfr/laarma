...
def generate_launch_description():
    ...
    img_zoom2_params = LaunchConfiguration("img_zoom2_params", default="/mnt/config/img_zoom2_params.yaml")  # new zoom
    ...
    container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                parameters=[cam_near_params, {"camera_ns": cam_ns}],
                remappings=[],
            ...
            ComposableNode(
                ...
                remappings=[
                    ...
                    ("/resized/image_raw", ["/", cam_ns, "/resized/image"]),
                    ("/resized/camera_info", ["/", cam_ns, "/resized/camera_info"]),
            ...
            ComposableNode(
                ...
                parameters=[img_zoom_params, img_ffmpeg_params],
                remappings=[
            ...
            ComposableNode(
                ...
                remappings=[
                    ("/in/image_raw", ["/", cam_ns, "/image"]),
                    ("/in/camera_info", ["/", cam_ns, "/camera_info"]),
                    ("/out/image_raw", ["/", cam_ns, "/zoomed2/image"]),
                    ("/out/camera_info", ["/", cam_ns, "/zoomed2/camera_info"]),
                    ("/out/image_raw/compressed", ["/", cam_ns, "/zoomed2/image/compressed"]),
                    ("/out/image_raw/compressedDepth", ["/", cam_ns, "/zoomed2/image/compressedDepth"]),
                    ("/out/image_raw/theora", ["/", cam_ns, "/zoomed2/image/theora"]),
                    ("/out/image_raw/ffmpeg", ["/", cam_ns, "/zoomed2/image/ffmpeg"]),
                ],
                extra_arguments=[{"use_intra_process_comms": True}],
            ),
            ComposableNode(
                package="image_proc",
                plugin="image_proc::ResizeNode",
                name=[cam_ns, "_crp2_resize_node"],
                parameters=[
                    img_resize_params,
                    img_ffmpeg_params,
                ],
                remappings=[
                    ("/image/image_raw", ["/", cam_ns, "/zoomed2/image"]),
                    ("/image/camera_info", ["/", cam_ns, "/zoomed2/camera_info"]),
                    ("/resize/image_raw", ["/", cam_ns, "/zoomed2/resized/image"]),
                    ("/resize/camera_info", ["/", cam_ns, "/zoomed2/resized/camera_info"]),
                    ("/resize/image_raw/compressed", ["/", cam_ns, "/zoomed2/resized/image/compressed"]),
                    ("/resize/image_raw/compressedDepth", ["/", cam_ns, "/zoomed2/resized/image/compressedDepth"]),
                    ("/resize/image_raw/theora", ["/", cam_ns, "/zoomed2/resized/image/theora"]),
                    ("/resize/image_raw/ffmpeg", ["/", cam_ns, "/zoomed2/resized/image/ffmpeg"]),
                ],
                extra_arguments=[{"use_intra_process_comms": True}],
            ),
            ComposableNode(
                package="topic_tools",
                plugin="topic_tools::ThrottleNode",
                name=[cam_ns, "_crp2_img_throttle_node"],
                parameters=[
                    {"input_topic": ["/", cam_ns, "/zoomed2/image"]},
                    {"output_topic": ["/", cam_ns, "/zoomed2/throttled/image"]},
                    img_throttle_params,
                ],
                extra_arguments=[{"use_intra_process_comms": True}],
            ),
            ComposableNode(
                package="image_proc",
                plugin="image_proc::ResizeNode",
                name=[cam_ns, "_crp2_thr_resize_node"],
                parameters=[
                    img_resize_params,
                    img_ffmpeg_params,
                ],
                remappings=[
                    ("/image/image_raw", ["/", cam_ns, "/zoomed2/throttled/image"]),
                    ("/image/camera_info", ["/", cam_ns, "/zoomed2/camera_info"]),
                    ("/resize/image_raw", ["/", cam_ns, "/zoomed2/throttled/resized/image"]),
                    ("/resize/camera_info", ["/", cam_ns, "/zoomed2/throttled/resized/camera_info"]),
                    ("/resize/image_raw/compressed", ["/", cam_ns, "/zoomed2/throttled/resized/image/compressed"]),
                    (
                        "/resize/image_raw/compressedDepth",
                        ["/", cam_ns, "/zoomed2/throttled/resized/image/compressedDepth"],
                    ),
                    ("/resize/image_raw/theora", ["/", cam_ns, "/zoomed2/throttled/resized/image/theora"]),
                    ("/resize/image_raw/ffmpeg", ["/", cam_ns, "/zoomed2/throttled/resized/image/ffmpeg"]),
                ],
                extra_arguments=[{"use_intra_process_comms": True}],
            ),
            ComposableNode(
            ...
            ComposableNode(
                package="yolov8",
                plugin="Yolov8Detector",
                name=[cam_ns, "_zoomed2_yolov8_detector_node"],
                parameters=[
                    img_yolo_params,
                ],
                remappings=[
                    ("/yolov8_detector/image", ["/", cam_ns, "/zoomed2/resized/image"]),
                    ("/yolov8_detector/image_with_detection", ["/", cam_ns, "/zoomed2/resized/image/detection"]),
                    ("/yolov8_detector/detection", ["/", cam_ns, "/zoomed2/resized/detection"]),
                ],
                extra_arguments=[{"use_intra_process_comms": True}],
            ),
        ],
